...
export default function Documents({ user }) {
  ...
  return <>
    ...
    <div className="content-table"><div className="table-scroll"><table className="data-table" data-testid="documents-table">
      <thead><tr><th data-testid="document-table-title">REGULASI</th><th>KATEGORI</th><th>UNIT PEMILIK</th><th>TANGGAL</th><th>STATUS</th><th>AKSI</th></tr></thead>
    ...
    <Modal title={detail?.title} open={!!detail} onClose={() => setDetail(null)} wide>{detail && <>
      ...
      <div className="form-actions">
        ...
        {admin && ['draft', 'rejected'].includes(detail.status) && <Btn disabled={busy} data-testid="document-submit-review" onClick={() => action(detail, 'submit')}><Send size={15} />Ajukan Review</Btn>}
