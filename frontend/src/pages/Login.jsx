...
export default function Login({ onLogin, expired }) {
  ...
  return <div className="login-page">
    ...
    <main className="login-composition">
      <section className="login-art" data-testid="login-art-panel" aria-label="Ilustrasi kantor bernuansa Bali"><div className="login-art-copy"><span className="login-art-eyebrow"><span />BERAKAR PADA INTEGRITAS</span><h2>Budaya patuh.<br />Kepercayaan yang tumbuh.</h2><p>Melangkah bersama, menjaga amanah.</p></div>
      ...
      <section className="login-form-panel" data-testid="login-form-panel"><div className="login-form-content"><div className="login-system-brand"><img data-testid="login-logo" src={assets.logo} alt="Bali Dwipa Jaya" /><div><span data-testid="login-app-name">{APP_NAME}</span><strong data-testid="login-bank-name">{BANK_NAME}</strong></div></div><div className="login-welcome"><h1 data-testid="login-heading">Selamat datang<br />kembali.</h1><p>Masuk untuk melanjutkan aktivitas kepatuhan Anda.</p></div>
        ...
        <form className="login-form" onSubmit={submit}>
          <label className="login-field"><span>Username</span><div className="login-input-wrap"><UserRound size={18} /><input data-testid="login-username" name="username" autoComplete="username" required maxLength={100} value={username} onChange={e => setUsername(e.target.value)} placeholder="Masukkan username" /></div></label>
